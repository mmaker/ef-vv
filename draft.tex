...
\begin{tabular}{|c|l|c|c|l|}
    ...
    \textbf{Orrù},  Michele & CNRS & 10 & 10 (Jul-Apr) & Project Coordinator \\
    \textbf{Chiesa}, Alessandro & EPFL & 5 & 10 (Jul-Apr) & Technical Advisor \\
    \textbf{TBD} & Ethereum Foundation & 20 & 10 (Jul-Apr) & PhD Student (Lean expert) \\
    \textbf{TBD} & Ethereum Foundation & 20 & 10 (Jul-Apr) & PhD Student (Lean expert) \\
    \textbf{TBD} & EPFL & 20 & 10 (Jul-Apr) & PhD Stud.\ (Lean expert) \\
    \textbf{TBD} & \textbf{TBD} & 40 & 2 (Jul-Sep) & Grad.\ Student (Proofreader) \\
...
\begin{ganttchart}[y unit title=0.4cm,
    ...
    group height=.3]{1}{10}
    %labels
    \gantttitle{Fiat--Shamir Project (Jul--Apr 2026)}{10} \\
    \gantttitle{Jul}{1}
    \gantttitle{Aug}{1}
    \gantttitle{Sep}{1}
    \gantttitle{Oct}{1}
